...
//defined scopes for permissions
const SCOPES = [
...
app.get('/', async (req, res) => {
  ...
  // Authorize a client with credentials and  call the Gmail API.
  ...
  // function used to Send reply to a message
  ...
  // Adding label to a message and move it to the label folder
  ...
  // Main function combines all togethor
  async function main() {
